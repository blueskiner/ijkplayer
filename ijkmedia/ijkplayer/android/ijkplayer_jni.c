...
#define JNI_MODULE_PACKAGE      "com/naxclow/media/player"
#define JNI_CLASS_IJKPLAYER     "com/naxclow/media/player/IjkMediaPlayer"
#define JNI_IJK_MEDIA_EXCEPTION "com/naxclow/media/player/exceptions/IjkMediaException"
...
static JNINativeMethod g_methods[] = {
    ...
    { "_setDataSource",         "(Lcom/naxclow/media/player/misc/IMediaDataSource;)V", (void *)IjkMediaPlayer_setDataSourceCallback },
    { "_setAndroidIOCallback",  "(Lcom/naxclow/media/player/misc/IAndroidIO;)V", (void *)IjkMediaPlayer_setAndroidIOCallback },
